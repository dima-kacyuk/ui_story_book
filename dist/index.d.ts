 ...
 */
declare const DjHeader: React__default.FC<DjHeaderProps>;
 ...
 */
declare const Header: ({ logo, navItems, theme, currentTheme, onThemeToggle, onLogin, onSignup }: HeaderProps) => react_jsx_runtime.JSX.Element;
